...
function getMetricSectionDefinitions() {
  return [
    { title: t('reporte.metrics.section.planning'), fields: [['planningMembersPresent', t('reporte.metrics.field.membersPresent')], ['planningMembersAbsent', t('reporte.metrics.field.membersAbsent')]] },
    { title: t('reporte.metrics.section.reach'), fields: [['reachMembersPresent', t('reporte.metrics.field.membersPresent')], ['reachPrivilegedMembers', t('reporte.metrics.field.privilegedMembers')], ['reachFriendsPresent', t('reporte.metrics.field.friendsPresent')], ['reachConversions', t('reporte.metrics.field.conversions')], ['reachKidsPresent', t('reporte.metrics.field.kidsPresent')], ['reachOffering', t('reporte.metrics.field.offering')]] },
    { title: t('reporte.metrics.section.multiply'), fields: [['multiplyBrothersNewCell', t('reporte.metrics.field.brothersNewCell')], ['multiplyPEinNewCell', t('reporte.metrics.field.spiritualParents')], ['multiplyKidsNewCell', t('reporte.metrics.field.kidsNewCell')], ['multiplySundayAttendance', t('reporte.metrics.field.serviceAttendance')]] },
    { title: t('reporte.metrics.section.win'), fields: [['winSpiritualParents', t('reporte.metrics.field.spiritualParents')], ['winFriendsContacted', t('reporte.metrics.field.friendsContacted')], ['winRiseEventFriends', t('reporte.metrics.field.friendsRise')], ['winEDRFriends', t('reporte.metrics.field.friendsEdr')], ['winBaptizedFriends', t('reporte.metrics.field.friendsBaptized')]] },
    { title: t('reporte.metrics.section.consolidate'), fields: [['consolidateE1', 'E1'], ['consolidateE2', 'E2'], ['consolidateE3', 'E3'], ['consolidateJoinEvent', t('reporte.metrics.field.joinEvent')], ['consolidateReencuentro', t('reporte.metrics.field.reencounter')], ['consolidateMinistries', t('reporte.metrics.field.ministries')]] },
    { title: t('reporte.metrics.section.disciple'), fields: [['discipleE1Vision', t('reporte.metrics.field.e1Vision')], ['discipleE2Character', t('reporte.metrics.field.e2Character')], ['discipleE3Profile', t('reporte.metrics.field.e3Profile')], ['discipleLaunchMultiply', t('reporte.metrics.field.launchMultiply')]] },
    { title: t('reporte.metrics.section.supervision'), fields: [['supervisionNetwork', t('reporte.metrics.field.network')], ['supervisionSector', t('reporte.metrics.field.sector')], ['supervisionZone', t('reporte.metrics.field.zone')], ['supervisionRegion', t('reporte.metrics.field.region')], ['supervisionArea', t('reporte.metrics.field.area')]] },
    { title: t('reporte.metrics.section.schools'), fields: [['schoolFormative', t('reporte.metrics.field.schoolFormative')], ['schoolParents', t('reporte.metrics.field.schoolParents')], ['schoolLeaders', t('reporte.metrics.field.schoolLeaders')], ['schoolSupervisors', t('reporte.metrics.field.schoolSupervisors')]] },
    { title: t('reporte.metrics.section.baptisms'), fields: [['baptismFirstQuarter', 'Q1'], ['baptismSecondQuarter', 'Q2'], ['baptismThirdQuarter', 'Q3'], ['baptismYearTotal', t('reporte.baptisms.annual')]] },
  ];
}
...
function getMetricHint(fieldName, weeklySummary) {
  ...
  if (fieldName === 'reachMembersPresent') {
    return `${t('reporte.preview.count.baseMembers', { count: String(reachMembersBase) })} · ${t('reporte.preview.count.externalShort', { count: String(Number(weeklySummary.reachSupervisorVisits || 0)) })}`;
  }
  if (fieldName === 'multiplySundayAttendance') {
    return `${t('reporte.preview.count.membersShort', { count: String(Number(weeklySummary.sundayMembersPresent || 0)) })} · ${t('reporte.preview.count.friendsShort', { count: String(Number(weeklySummary.sundayFriendsPresent || 0)) })} · ${t('reporte.preview.count.kidsShort', { count: String(Number(weeklySummary.sundayKidsPresent || 0)) })}`;
  }
  return '';
}
    ...
    return `
      <section class="panel panel-soft metric-card metric-card--compact">
        <div class="metric-card-title-row">
          ...
          <span class="metric-card-kind">${escapeHtml(isAllAuto ? t('reporte.metrics.kind.auto') : t('reporte.metrics.kind.manual'))}</span>
        </div>
          ...
          ${section.fields.map(([fieldName, label]) => {
            ...
            return `
              <label class="metric-field${isAuto ? ' is-auto' : ''}">
                <span>${escapeHtml(label)}${isAuto ? `<em class="metric-auto-tag">${escapeHtml(t('reporte.metrics.autoTag'))}</em>` : ''}</span>
...
function formatRole(role) {
  if (role === 'kid') return t('reporte.role.kid');
  return t('reporte.role.member');
}
...
function getPreviewMetricHint(fieldName, weeklySummary, friendsCount, restorCount) {
  if (fieldName === 'reachMembersPresent') {
    return `${t('reporte.preview.count.baseMembers', { count: String(Number(weeklySummary.reachMembersBase || 0)) })} · ${t('reporte.preview.count.externalShort', { count: String(Number(weeklySummary.reachSupervisorVisits || 0)) })}`;
  }
  if (fieldName === 'reachFriendsPresent' && restorCount > 0) {
    return `${t('reporte.preview.count.friendsShort', { count: String(friendsCount) })} · ${t('reporte.preview.count.restorationShort', { count: String(restorCount) })}`;
  }
  if (fieldName === 'multiplySundayAttendance') {
    return `${t('reporte.preview.count.membersShort', { count: String(Number(weeklySummary.sundayMembersPresent || 0)) })} · ${t('reporte.preview.count.friendsShort', { count: String(Number(weeklySummary.sundayFriendsPresent || 0)) })} · ${t('reporte.preview.count.kidsShort', { count: String(Number(weeklySummary.sundayKidsPresent || 0)) })}`;
  }
...
export function buildHistoryPreviewHtml(report, options = {}) {
  ...
  const headerHtml = `
    <div class="preview-header-card">
      <div class="preview-header-grid">
        <div><span class="preview-label">${escapeHtml(t('reporte.preview.header.week'))}</span><strong>${escapeHtml(week)}${phaseLabel ? ` · ${escapeHtml(phaseLabel)}` : ''}</strong></div>
        <div><span class="preview-label">${escapeHtml(t('reporte.preview.header.cell'))}</span><strong>${escapeHtml(cellNumber)}</strong></div>
        <div><span class="preview-label">${escapeHtml(t('reporte.preview.header.date'))}</span><strong>${escapeHtml(formData.reportDate || report?.reportDate || '—')}</strong></div>
        <div><span class="preview-label">${escapeHtml(t('reporte.preview.header.leader'))}</span><strong>${escapeHtml(formData.leaderName || report?.leaderName || '—')}</strong></div>
        ${formData.assistantName ? `<div><span class="preview-label">${escapeHtml(t('reporte.preview.header.assistant'))}</span><strong>${escapeHtml(formData.assistantName)}</strong></div>` : ''}
        ${formData.hostName ? `<div><span class="preview-label">${escapeHtml(t('reporte.preview.header.host'))}</span><strong>${escapeHtml(formData.hostName)}</strong></div>` : ''}
        ${formData.sector ? `<div><span class="preview-label">${escapeHtml(t('reporte.preview.header.sector'))}</span><strong>${escapeHtml(formData.sector)}</strong></div>` : ''}
        ${formData.networkName ? `<div><span class="preview-label">${escapeHtml(t('reporte.preview.header.network'))}</span><strong>${escapeHtml(formData.networkName)}</strong></div>` : ''}
      </div>
    </div>`;

  const attendanceHtml = `
    <div class="preview-section-title">${escapeHtml(t('reporte.preview.section.attendance'))}</div>
    <div class="preview-cards-row">
      ${[
        [t('reporte.preview.stat.members'), weeklySummary.planningMembersPresent],
        [t('reporte.preview.stat.friends'), visitors.length],
        [t('reporte.preview.stat.kids'), kids.length],
        [t('reporte.preview.stat.service'), weeklySummary.sundayTotal],
        [t('reporte.metrics.field.conversions'), weeklySummary.reachConversions],
      ].map(([label, value]) => `
  ...
  const integratedEventParts = [
    reachEventSummaries.length ? t('reporte.preview.integrated.reach', { events: reachEventSummaries.map((entry) => entry.event).join(' / ') }) : '',
    sundayEventSummaries.length ? t('reporte.preview.integrated.service', { events: sundayEventSummaries.map((entry) => entry.event).join(' / ') }) : '',
  ].filter(Boolean);
  const eventOverviewHtml = (separateEventSummaries.length || integratedEventParts.length) ? `
    <div class="preview-section-title">${escapeHtml(t('reporte.preview.section.specialEvents'))}</div>
      ...
      <div class="preview-cards-row" style="margin-bottom:4px">
        ${separateEventSummaries.map((entry) => `
          <div class="preview-stat-card">
            ...
            <span class="preview-stat-lbl">${escapeHtml(entry.event)} · ${escapeHtml(t('reporte.preview.separateSuffix'))}</span>
          </div>`).join('')}
      </div>` : ''}
    ${integratedEventParts.length ? `<p class="preview-empty-note" style="margin-top:0;margin-bottom:8px">${escapeHtml(t('reporte.preview.integrated.week', { items: integratedEventParts.join(' · ') }))}</p>` : ''}` : '';

  const summaryItems = [
    conversions ? [t('reporte.metrics.field.conversions'), conversions, 'is-highlight'] : null,
    baptisms ? [t('reporte.preview.stat.baptisms'), baptisms, 'is-highlight'] : null,
    Number(weeklySummary.winSpiritualParents || 0) ? [t('reporte.preview.stat.spiritualParents'), Number(weeklySummary.winSpiritualParents || 0), ''] : null,
    totalOffering ? [t('reporte.preview.stat.offeringTotal'), `$${totalOffering.toFixed(0)}`, ''] : null,
  ].filter(Boolean);
  ...
  const planSection = `
    <div class="ev-section">
      <div class="ev-head ev-head--planning">
        <span class="ev-title">📋 ${escapeHtml(t('reporte.metrics.section.planning'))}</span>
        <span class="ev-count">${escapeHtml(String(planCount))} / ${escapeHtml(String(planTotal))} ${escapeHtml(t('reporte.preview.stat.members').toLowerCase())}</span>
      </div>
      <div class="ev-body">
        ${planTotal ? `<div class="ev-chip-grid">${memberAttendance.map((entry) => memberChip(entry, entry.planningAttended, null, entry.planningStatus)).join('')}</div>` : `<p class='preview-empty-note'>${escapeHtml(t('reporte.preview.empty.noAttendance'))}</p>`}
  ...
  const visitorsTitle = restorCount > 0
    ? `${t('reporte.preview.stat.friends')} (${friendsCount}) · ${t('reporte.visitors.restoration')} (${restorCount})`
    : `${t('reporte.preview.stat.friends')} (${friendsCount})`;
  const externalHtml = externalParticipants.length ? `
    <div class="ev-subsection">
      <p class="ev-subsection-title">${escapeHtml(t('reporte.preview.externalTitle', { count: String(externalParticipants.length) }))}</p>
      <div class="ev-visitor-list">
        ${externalParticipants.map((entry) => `
          <div class="ev-visitor-row">
            <span class="ev-visitor-name">${escapeHtml(entry.kind === 'member_visit' ? t('reporte.preview.external.member') : t('reporte.preview.external.supervision'))} · ${escapeHtml(entry.name || '')}</span>
            ${entry.relatedSector ? `<span class="ev-visitor-meta">${escapeHtml(t('reporte.preview.sectorMeta', { sector: entry.relatedSector }))}</span>` : ''}
            ${entry.homeCellNumber ? `<span class="ev-visitor-meta">${escapeHtml(t('reporte.preview.cellMeta', { cell: entry.homeCellNumber }))}</span>` : ''}
          </div>`).join('')}
      </div>
    </div>` : '';
  const visitorsHtml = visitors.length ? `
    <div class="ev-subsection">
      <div class="ev-subsection-head">
        ...
        <button type="button" class="preview-section-action" data-action="open-preview-visitors">${escapeHtml(t('reporte.preview.viewDetail'))}</button>
      </div>
      <div class="ev-visitor-list">
        ${visitors.map((entry) => `
          <div class="ev-visitor-row">
            <span class="ev-visitor-name">${escapeHtml(entry.name || '')}</span>
            ${entry.invitedBy ? `<span class="ev-visitor-meta">${escapeHtml(t('reporte.preview.invitedBy', { name: entry.invitedBy }))}</span>` : ''}
            <span class="ev-visitor-badges">
              ${entry.converted ? `<span class="ev-badge ev-badge--conversion">${escapeHtml(t('reporte.visitors.conversion'))}</span>` : ''}
              ${entry.sundayAttended ? `<span class="ev-badge ev-badge--sunday">↪ ${escapeHtml(t('reporte.stage.service'))}</span>` : ''}
            </span>
          </div>`).join('')}
      </div>
    </div>` : '';
  const kidsHtml = kids.length ? `
    <div class="ev-subsection">
      <p class="ev-subsection-title">${escapeHtml(t('reporte.preview.stat.kids'))} (${escapeHtml(String(kids.length))})</p>
      <div class="ev-visitor-list">
        ${kids.map((entry) => `
          <div class="ev-visitor-row">
            <span class="ev-visitor-name">${escapeHtml(entry.name || '')}</span>
            ${entry.guardianName ? `<span class="ev-visitor-meta">${escapeHtml(t('reporte.preview.guardian', { name: entry.guardianName }))}</span>` : ''}
            ${entry.sundayAttended ? `<span class="ev-badge ev-badge--sunday">↪ ${escapeHtml(t('reporte.stage.service'))}</span>` : ''}
          </div>`).join('')}
      </div>
    </div>` : '';
  const reachEventsHtml = reachEventSummaries.length ? `
    <div class="ev-subsection">
      <p class="ev-subsection-title">${escapeHtml(t('reporte.preview.reportedInReach'))}</p>
      <div class="ev-visitor-list">
        ${reachEventSummaries.map((entry) => `
          <div class="ev-visitor-row">
            <span class="ev-visitor-name">${escapeHtml(entry.event)}</span>
            <span class="ev-visitor-meta">${escapeHtml(t('reporte.preview.count.membersShort', { count: String(entry.memberCount) }))} · ${escapeHtml(t('reporte.preview.count.friendsShort', { count: String(entry.friendCount) }))}${entry.restorationCount ? ` · ${escapeHtml(t('reporte.preview.count.restorationShort', { count: String(entry.restorationCount) }))}` : ''}</span>
          </div>`).join('')}
      </div>
    </div>` : '';
  const reachSection = `
    <div class="ev-section">
      <div class="ev-head ev-head--reach">
        <span class="ev-title">🌱 ${escapeHtml(t('reporte.preview.reachTitle'))}${reachEventSummaries.length ? ` · ${escapeHtml(reachEventSummaries.map((entry) => entry.event).join(' / '))}` : ''}</span>
        <span class="ev-count">${escapeHtml(t('reporte.preview.count.membersShort', { count: String(reachPresent) }))}${reachPrivileged ? ` · ${escapeHtml(t('reporte.preview.count.privilegedShort', { count: String(reachPrivileged) }))}` : ''}${externalParticipants.length ? ` · ${escapeHtml(t('reporte.preview.count.externalShort', { count: String(externalParticipants.length) }))}` : ''} · ${escapeHtml(t('reporte.preview.count.friendsShort', { count: String(friendsCount) }))}${restorCount ? ` · ${escapeHtml(t('reporte.preview.count.restorationShort', { count: String(restorCount) }))}` : ''} · ${escapeHtml(t('reporte.preview.count.kidsShort', { count: String(kids.length) }))}</span>
      </div>
      <div class="ev-body">
        ...
        ${visitorsHtml}
        ${kidsHtml}
        ${totalOffering ? `<p class="ev-offering">${escapeHtml(t('reporte.preview.offeringReach', { amount: totalOffering.toFixed(0) }))}</p>` : ''}
  ...
  const sundayEventsHtml = sundayEventSummaries.length ? `
    <div class="ev-subsection">
      <p class="ev-subsection-title">${escapeHtml(t('reporte.preview.reportedInService'))}</p>
      <div class="ev-visitor-list">
  ...
  const cultoSection = `
    <div class="ev-section">
      <div class="ev-head ev-head--sunday">
        <span class="ev-title">${escapeHtml(t('reporte.preview.serviceTitle'))}${sundayEventSummaries.length ? ` · ${escapeHtml(sundayEventSummaries.map((entry) => entry.event).join(' / '))}` : ''}</span>
        <span class="ev-count">${escapeHtml(t('reporte.preview.count.totalShort', { count: String(sundayTotal) }))} · ${escapeHtml(t('reporte.preview.count.membersShort', { count: String(sundayMembersCount) }))} · ${escapeHtml(t('reporte.preview.count.friendsShort', { count: String(sundayVisitorsCount) }))} · ${escapeHtml(t('reporte.preview.count.kidsShort', { count: String(sundayKidsCount) }))}</span>
      </div>
      <div class="ev-body">
        ${planTotal ? `<div class="ev-chip-grid">${memberAttendance.map((entry) => memberChip(entry, entry.sundayAttended, null, entry.sundayStatus)).join('')}</div>` : `<p class='preview-empty-note'>${escapeHtml(t('reporte.preview.empty.noAttendance'))}</p>`}
        ${sundayEventsHtml}
  ...
  const separateEventsHtml = separateEventSummaries.map((entry) => {
    const memberChips = entry.members.length
      ...
      : `<p class="preview-empty-note">${escapeHtml(t('reporte.preview.empty.noMembersEvent'))}</p>`;
    const visitorRows = entry.visitors.length
      ? `<div class="ev-visitor-list">${entry.visitors.map((visitor) => `
          <div class="ev-visitor-row">
            ...
            <span class="ev-visitor-meta">${escapeHtml((visitor.kind || 'amigo') === 'visita' ? t('reporte.visitors.restoration') : t('reporte.visitors.kind.friend'))}${visitor.invitedBy ? ` · ${escapeHtml(t('reporte.preview.invitedBy', { name: visitor.invitedBy }))}` : ''}</span>
          </div>`).join('')}</div>`
      : `<p class="preview-empty-note">${escapeHtml(t('reporte.preview.empty.noFriendsEvent'))}</p>`;
    return `
      <div class="ev-section">
        <div class="ev-head ev-head--planning">
          <span class="ev-title">${escapeHtml(t('reporte.preview.separateEventTitle', { event: entry.event }))}</span>
          <span class="ev-count">${escapeHtml(t('reporte.preview.count.membersShort', { count: String(entry.memberCount) }))} · ${escapeHtml(t('reporte.preview.count.friendsShort', { count: String(entry.friendCount) }))}${entry.restorationCount ? ` · ${escapeHtml(t('reporte.preview.count.restorationShort', { count: String(entry.restorationCount) }))}` : ''}</span>
        </div>
        <div class="ev-body">
          ${memberChips}
          <div class="ev-subsection">
            <p class="ev-subsection-title">${escapeHtml(t('reporte.preview.eventAttendance'))}</p>
            ${visitorRows}
          </div>
        </div>
      </div>`;
  ...
  const legendHtml = `
    <div class="ev-legend">
      <span class="ev-legend-title">${escapeHtml(t('reporte.preview.legendTitle'))}</span>
      <span class="ev-chip ev-chip--attended" style="font-size:0.7rem;padding:2px 7px 2px 4px"><span class="ev-chip-icon">✓</span>${escapeHtml(t('reporte.preview.legend.attended'))}</span>
      <span class="ev-chip ev-chip--privileged" style="font-size:0.7rem;padding:2px 7px 2px 4px"><span class="ev-chip-icon">★</span>${escapeHtml(t('reporte.preview.legend.privileged'))}</span>
      <span class="ev-chip ev-chip--missed" style="font-size:0.7rem;padding:2px 7px 2px 4px"><span class="ev-chip-icon">✗</span>${escapeHtml(t('reporte.preview.legend.missed'))}</span>
      <span class="ev-chip ev-chip--justified" style="font-size:0.7rem;padding:2px 7px 2px 4px"><span class="ev-chip-icon">J</span>${escapeHtml(t('reporte.preview.legend.justified'))}</span>
      <span class="ev-badge ev-badge--sunday" style="font-size:0.7rem">↪ ${escapeHtml(t('reporte.stage.service'))}</span>
      <span class="ev-badge ev-badge--conversion" style="font-size:0.7rem">${escapeHtml(t('reporte.visitors.conversion'))}</span>
    </div>`;

  const stageBlocks = [
    { field: 'planningStatus', attendedField: 'planningAttended', label: t('reporte.metrics.section.planning') },
    { field: 'reachStatus', attendedField: 'reachAttended', label: t('reporte.metrics.section.reach') },
    { field: 'sundayStatus', attendedField: 'sundayAttended', label: t('reporte.stage.service') },
    ...
    return `
      <details class="preview-event-tree">
        ...
        <div class="preview-event-tree-body">
          ${present.length ? `<div class="preview-event-tree-group"><span class="preview-event-tree-grouplabel">${escapeHtml(t('reporte.preview.group.present', { count: String(present.length) }))}</span><div class="preview-pills">${present.map((entry) => `<span class="preview-pill is-present">${escapeHtml(entry.name || '')}</span>`).join('')}</div></div>` : ''}
          ${absent.length ? `<div class="preview-event-tree-group"><span class="preview-event-tree-grouplabel">${escapeHtml(t('reporte.preview.group.absent', { count: String(absent.length) }))}</span><div class="preview-pills">${absent.map((entry) => `<span class="preview-pill is-absent">${escapeHtml(entry.name || '')}</span>`).join('')}</div></div>` : ''}
          ${justified.length ? `<div class="preview-event-tree-group"><span class="preview-event-tree-grouplabel">${escapeHtml(t('reporte.preview.group.justified', { count: String(justified.length) }))}</span><div class="preview-pills">${justified.map((entry) => `<span class="preview-pill is-justified">${escapeHtml(entry.name || '')}</span>`).join('')}</div></div>` : ''}
          ${pending.length ? `<div class="preview-empty-note" style="margin-top:6px">${escapeHtml(t('reporte.preview.group.unmarked', { count: String(pending.length) }))}</div>` : ''}
          ${(!present.length && !absent.length && !justified.length) ? `<span class="preview-empty-note">${escapeHtml(t('reporte.preview.empty.noEventInfo'))}</span>` : ''}
        </div>
      </details>`;
  }).join('');

  const notesHtml = formData.notes ? `
    <div class="preview-section-title">${escapeHtml(t('reporte.preview.section.notes'))}</div>
  ...
  return `
    <dialog id="preview-visitors-dialog" class="app-dialog">
      <div class="dialog-head">
        <div>
          <p class="eyebrow">${escapeHtml(t('reporte.preview.visitorsEyebrow'))}</p>
          <h3 id="preview-visitors-dialog-title">${escapeHtml(t('reporte.preview.visitorsTitle', { count: visitors.length }))}</h3>
        </div>
        <button type="button" class="btn-icon-round" data-action="close-preview-visitors" aria-label="${escapeHtml(t('common.close'))}">✕</button>
      </div>
      <div id="preview-visitors-dialog-body" class="dialog-body">
        ${visitors.length ? `
          <div class="preview-visitors-picker-list">
            ${visitors.map((entry) => {
              const kind = (entry.kind || 'amigo') === 'visita' ? t('reporte.visitors.restoration') : t('reporte.visitors.kind.friend');
              const badges = [
                entry.reachAttended ? t('reporte.stage.reach') : '',
                entry.sundayAttended ? t('reporte.stage.service') : '',
                entry.converted ? t('reporte.visitors.conversion') : '',
              ].filter(Boolean).join(' · ');
              const meta = [kind, entry.invitedBy ? t('reporte.preview.invitedBy', { name: entry.invitedBy }) : '', badges].filter(Boolean).join(' · ');
              return `
                <div class="preview-visitors-picker-row">
                  <div class="preview-visitors-picker-main">
                    ...
                    <span class="preview-visitors-picker-meta">${escapeHtml(meta || t('reporte.preview.noExtraDetail'))}</span>
                  </div>
                </div>`;
            }).join('')}
          </div>`
          : `<p class="empty-state">${escapeHtml(t('reporte.preview.noFriends'))}</p>`}
      </div>
      <div class="dialog-footer">
        <button type="button" class="btn btn-ghost" data-action="close-preview-visitors">${escapeHtml(t('common.close'))}</button>
      </div>
    </dialog>
  `;
}
...
function renderHistoryPreviewDialog(state) {
  ...
  return `
    <dialog id="report-preview-dialog" class="app-dialog app-dialog-wide">
      <div class="dialog-head">
        <div>
          <p class="eyebrow">${escapeHtml(t('common.preview'))}</p>
          <h3 id="preview-dialog-title">${previewReport ? escapeHtml(t('reporte.preview.dialogTitle', { cell: previewReport.formData?.cellNumber || previewReport.cellNumber || '—', week: previewReport.formData?.week || previewReport.week || '—' })) : escapeHtml(t('feature.reporte'))}</h3>
        </div>
        <button type="button" class="btn-icon-round" data-action="close-preview-report" aria-label="${escapeHtml(t('common.close'))}">✕</button>
      </div>
      ...
      <div class="dialog-footer" id="preview-dialog-footer">
        <button id="preview-cancel-btn" type="button" class="btn btn-ghost" data-action="close-preview-report">${escapeHtml(t('reporte.preview.continueEditing'))}</button>
        ...
        <button id="preview-download-btn" type="button" class="btn btn-ghost" hidden>
          ...
          <span>${escapeHtml(t('reporte.preview.downloadPng'))}</span>
        </button>
        <button id="preview-whatsapp-btn" type="button" class="btn btn-ghost" hidden>
          ...
          <span>${escapeHtml(t('reporte.preview.shareWhatsApp'))}</span>
        </button>
        <button id="preview-confirm-btn" type="button" class="btn btn-primary" hidden>${escapeHtml(t('reporte.preview.confirmSave'))}</button>
      </div>
    </dialog>
  `;
}
...
function renderConfirmDialog() {
  return `
    <dialog id="app-confirm-dialog" class="app-dialog app-confirm-dialog">
      <div class="dialog-head">
        <h3 id="app-confirm-title">${escapeHtml(t('common.confirm'))}</h3>
      </div>
      <div class="dialog-body">
        <p id="app-confirm-message" style="margin:0;white-space:pre-line;line-height:1.6;"></p>
      </div>
      <div class="dialog-footer">
        <button id="app-confirm-cancel" type="button" class="btn-secondary">${escapeHtml(t('common.cancel'))}</button>
        <button id="app-confirm-ok" type="button" class="btn-primary">${escapeHtml(t('common.confirm'))}</button>
      </div>
    </dialog>
  `;
}
    ...
    return `
      <section class="panel panel-table full-width">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.history.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.history.title'))}</h2>
          </div>
        ...
        <div id="report-cycles-list">
          <p class="empty-state" style="padding:16px 0">
            ${escapeHtml(t('reporte.history.redirectPrefix'))}
            <button type="button" class="link-inline" data-action="go-seguimiento">${escapeHtml(t('reporte.history.redirectLink'))}</button>.
          </p>
        </div>
...
export function renderReporteShell(state) {
  ...
  const stageLabels = {
    encabezado: t('reporte.stage.start'),
    planificacion: t('reporte.stage.planning'),
    alcance: t('reporte.stage.reach'),
    culto: t('reporte.stage.service'),
    cierre: t('reporte.stage.close'),
  };
  ...
  const saveDisabledAttr = canEditCurrentReport ? '' : ` disabled title="${escapeHtml(t('reporte.readonly.saveTitle'))}"`;
  ...
  return `
    <section id="report-view" class="workspace-main report-next">
      <div id="report-readonly-banner" class="readonly-banner"${canEditCurrentReport ? ' hidden' : ''}>
        🔒 ${escapeHtml(t('reporte.readonly.locked'))}
      </div>
      <nav class="stage-nav full-width" id="stage-nav" aria-label="${escapeHtml(t('reporte.stageNav.aria'))}">
        <button type="button" class="${tabClass('encabezado')}" data-stage="encabezado">
          <span class="stage-tab-num">1</span>
          <span class="stage-tab-label">${escapeHtml(stageLabels.encabezado)}</span>
        ...
        <button type="button" class="${tabClass('planificacion')}" data-stage="planificacion">
          ...
          <span class="stage-tab-label">${escapeHtml(stageLabels.planificacion)}</span>
        ...
        <button type="button" class="${tabClass('alcance')}" data-stage="alcance">
          ...
          <span class="stage-tab-label">${escapeHtml(stageLabels.alcance)}</span>
        ...
        <button type="button" class="${tabClass('culto')}" data-stage="culto">
          ...
          <span class="stage-tab-label">${escapeHtml(stageLabels.culto)}</span>
        ...
        <button type="button" class="${tabClass('cierre')}" data-stage="cierre">
          ...
          <span class="stage-tab-label">${escapeHtml(stageLabels.cierre)}</span>
      ...
      <form id="report-form" class="stack-grid full-width">
        <div id="form-readonly-banner" class="form-readonly-banner"${canEditCurrentReport ? ' hidden' : ''}>${escapeHtml(t('reporte.readonly.form'))}</div>
        <section class="panel inicio-capture-card${stageClass('encabezado')}" data-stage="encabezado">
          <div class="panel-head">
            <div>
              <p class="eyebrow">${escapeHtml(t('reporte.capture'))}</p>
              <h2>${escapeHtml(t('reporte.start.title'))}</h2>
            </div>
            <span class="panel-tag">${escapeHtml(t('reporte.week.active'))}</span>
          </div>
          <div class="inicio-primary-fields">
            <label>
              <span>${escapeHtml(t('reporte.week.label'))}</span>
            ...
            <label>
              <span>${escapeHtml(t('reporte.cell.label'))}</span>
              <select id="cell-field" name="cellNumber"${state.canEditCell ? '' : ' disabled'} required>
                <option value="">${escapeHtml(t('reporte.cell.select'))}</option>
          ...
          <div class="report-grid inicio-secondary-fields">
            ...
            <label>
              <span>${escapeHtml(t('reporte.sector.catalog'))}</span>
            ...
            <label>
              <span>${escapeHtml(t('reporte.district.catalog'))}</span>
        ...
        <section class="panel panel-soft inicio-team-card${stageClass('encabezado')}" data-stage="encabezado">
          <div class="panel-head">
            <div>
              <p class="eyebrow">${escapeHtml(t('reporte.team'))}</p>
              <h2>${escapeHtml(t('reporte.leadership.title'))}</h2>
            </div>
            <span id="member-count-chip" class="count-chip">${escapeHtml(t('reporte.members.count', { count: form.memberAttendance.length }))}</span>
          </div>
          <div class="inicio-team-grid">
            <label class="inicio-leader-field">
              <span>${escapeHtml(t('reporte.leader.catalog'))}</span>
              <select id="leader-field" name="leaderName"${lockCatalogFields ? ' disabled' : ''} required>
                <option value="">${escapeHtml(t('reporte.leader.select'))}</option>
            ...
            <label>
              <span>${escapeHtml(t('reporte.assistant.catalog'))}</span>
              <select id="assistant-field" name="assistantName"${lockCatalogFields ? ' disabled' : ''}>
                <option value="">${escapeHtml(t('reporte.assistant.select'))}</option>
            ...
            <label>
              <span>${escapeHtml(t('reporte.host.catalog'))}</span>
              <select id="host-field" name="hostName"${lockCatalogFields ? ' disabled' : ''}>
                <option value="">${escapeHtml(t('reporte.host.select'))}</option>
          ...
          <div class="inicio-location-row">
            <label class="inicio-address-field">
              <span>${escapeHtml(t('reporte.address.catalog'))}</span>
            ...
            <label class="inicio-date-field">
              <span>${escapeHtml(t('reporte.meetingDate.label'))}</span>
              <input name="reportDate" type="date" value="${escapeHtml(form.reportDate || '')}" required>
            </label>
          </div>
          <div class="member-summary">
            <span class="member-summary-label">${escapeHtml(t('reporte.members.assigned'))}</span>
            <div id="report-member-pills" class="pill-row">
              ${form.memberAttendance.length
                ...
                : `<span class="member-summary-label">${escapeHtml(t('reporte.members.empty'))}</span>`}
            </div>
          </div>
        </section>
        ...
        <div class="stage-save-bar full-width${stageClass('encabezado')}" data-stage="encabezado">
          <button type="button" id="save-next-encabezado" class="btn-save-next btn-with-icon" data-action="save-report-stage" data-next-stage="planificacion"${saveDisabledAttr}>
            ...
            <span>${escapeHtml(t('reporte.saveContinue'))}</span>
          </button>
        </div>
      </form>
      <div class="full-width${stageClass('planificacion alcance culto')}" data-stage="planificacion alcance culto">
        <div class="summary-grid summary-grid-compact" id="attendance-summary-cards">
          <article class="summary-card summary-card-mini" data-summary-stage="planificacion">
            <span class="summary-label">${escapeHtml(stageLabels.planificacion)}</span>
          ...
          <article class="summary-card summary-card-mini" data-summary-stage="alcance">
            <span class="summary-label">${escapeHtml(stageLabels.alcance)}</span>
          ...
          <article class="summary-card summary-card-mini" data-summary-stage="culto">
            <span class="summary-label">${escapeHtml(stageLabels.culto)}</span>
          ...
          <article class="summary-card summary-card-mini" data-summary-stage="alcance">
            <span class="summary-label">${escapeHtml(t('reporte.friends'))}</span>
            <strong class="summary-value">${escapeHtml(namedVisitorsCount)}</strong>
          </article>
          <article class="summary-card summary-card-mini" data-summary-stage="alcance">
            <span class="summary-label">${escapeHtml(t('reporte.kids'))}</span>
      ...
      <section class="panel panel-soft full-width${stageClass('planificacion alcance culto')}" data-stage="planificacion alcance culto">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.weekly.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.membersAttendance.title'))}</h2>
          </div>
          <span id="attendance-progress-chip" class="count-chip">${escapeHtml(t('reporte.markedCount', { count: attendanceMarkedCount }))}</span>
        </div>
        <div class="helper-actions" aria-label="${escapeHtml(t('reporte.memberShortcuts.aria'))}">
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="fill-planning-members" data-stage-action="planificacion" id="fill-planning-members" data-tooltip="${escapeHtml(t('reporte.members.fillPlanning.tooltip'))}">
            ...
            <span>${escapeHtml(t('reporte.members.fillPlanning'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="fill-reach-members" data-stage-action="alcance" id="fill-reach-members" data-tooltip="${escapeHtml(t('reporte.members.fillReach.tooltip'))}">
            ...
            <span>${escapeHtml(t('reporte.members.fillReach'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="fill-reach-privileges" data-stage-action="alcance" id="fill-reach-privileges" data-tooltip="${escapeHtml(t('reporte.members.fillReachPrivileges.tooltip'))}">
            ...
            <span>${escapeHtml(t('reporte.members.fillReachPrivileges'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="fill-sunday-members" data-stage-action="culto" id="fill-sunday-members" data-tooltip="${escapeHtml(t('reporte.members.fillSunday.tooltip'))}">
            ...
            <span>${escapeHtml(t('reporte.members.fillSunday'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="copy-reach-to-sunday" data-stage-action="culto" id="copy-reach-to-sunday" data-tooltip="${escapeHtml(t('reporte.members.copyReachToSunday.tooltip'))}">
            ...
            <span>${escapeHtml(t('reporte.members.copyReachToSunday'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button btn-with-icon" data-action="clear-member-activities" id="clear-member-activities" data-tooltip="${escapeHtml(t('reporte.members.clearActivities.tooltip'))}">
            <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>
            <span>${escapeHtml(t('reporte.members.clearActivities'))}</span>
          </button>
        </div>
        <div class="table-wrap weekly-table-wrap">
          <table>
            <thead>
              <tr>
                <th>${escapeHtml(t('reporte.column.member'))}</th>
                <th>${escapeHtml(t('reporte.column.weeklyStatus'))}</th>
                <th>${escapeHtml(t('reporte.column.planning'))}</th>
                <th>${escapeHtml(reachStageLabel)}</th>
                <th>${escapeHtml(t('reporte.column.privileges'))}</th>
                ...
                ${showMemberEventColumn
                  ...
                  : ''}
                <th>${escapeHtml(t('reporte.column.note'))}</th>
              </tr>
            </thead>
            <tbody id="attendance-table-body">
              ${form.memberAttendance.length ? form.memberAttendance.map((entry, index) => `
                <tr>
                  <td data-label="${escapeHtml(t('reporte.column.member'))}">
                  ...
                  <td data-label="${escapeHtml(t('reporte.column.weeklyStatus'))}">
                    <select data-attendance-index="${escapeHtml(index)}" data-attendance-field="status">
                      <option value="pending"${String((stageStatusField ? entry?.[stageStatusField] : entry?.status) || 'pending').toLowerCase() === 'pending' ? ' selected' : ''}>${escapeHtml(t('reporte.status.pending'))}</option>
                      <option value="present"${String((stageStatusField ? entry?.[stageStatusField] : entry?.status) || '').toLowerCase() === 'present' ? ' selected' : ''}>${escapeHtml(t('reporte.status.present'))}</option>
                      <option value="absent"${String((stageStatusField ? entry?.[stageStatusField] : entry?.status) || '').toLowerCase() === 'absent' ? ' selected' : ''}>${escapeHtml(t('reporte.status.absent'))}</option>
                      <option value="justified"${String((stageStatusField ? entry?.[stageStatusField] : entry?.status) || '').toLowerCase() === 'justified' ? ' selected' : ''}>${escapeHtml(t('reporte.status.justified'))}</option>
                      <option value="service"${String((stageStatusField ? entry?.[stageStatusField] : entry?.status) || '').toLowerCase() === 'service' ? ' selected' : ''}>${escapeHtml(t('reporte.status.service'))}</option>
                    </select>
                  </td>
                  <td data-label="${escapeHtml(t('reporte.column.planning'))}" class="checkbox-cell">
                  ...
                  <td data-label="${escapeHtml(t('reporte.column.privileges'))}" class="checkbox-cell">
                  ...
                  ${showMemberEventColumn
                    ...
                    : ''}
                  <td data-label="${escapeHtml(t('reporte.column.note'))}">
                    <input data-attendance-index="${escapeHtml(index)}" data-attendance-field="note" type="text" value="${escapeHtml(entry.note || '')}" placeholder="${escapeHtml(t('reporte.note.placeholder'))}">
                  </td>
                </tr>
              `).join('') : `
                <tr>
                  <td colspan="${escapeHtml(totalAttendanceCols)}" class="empty-state">${escapeHtml(t('reporte.members.emptySelectCell'))}</td>
                </tr>
              `}
            </tbody>
          </table>
        ...
        <div class="member-summary">
          <span class="member-summary-label"${absentSummaryHtml ? '' : ' style="display:none"'}>${escapeHtml(t('reporte.members.absentThisWeek'))}</span>
      ...
      <section class="fn-shell__card fn-shell__card--feature panel panel-soft full-width${stageClass('alcance culto')}" data-stage="alcance culto">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.weekly.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.visitors.title'))}</h2>
          </div>
          <button
          ...
          >
            ...
            <span class="visitor-quick-history-toolbar-label">${hiddenVisitorHistoryCount > 0 ? escapeHtml(t('reporte.visitors.restoreHiddenCount', { count: hiddenVisitorHistoryCount })) : escapeHtml(t('reporte.visitors.restoreHidden'))}</span>
          </button>
        </div>
        <div id="visitor-quick-form" class="visitor-quick-form">
          <label>
            <span>${escapeHtml(t('reporte.visitors.previousVisit'))}</span>
            <select id="visitor-quick-history" class="fn-select" data-visitor-field="historySelection">
              <option value="">${visibleVisitorHistory.length ? escapeHtml(t('reporte.quickHistory.choose', { count: visibleVisitorHistory.length })) : escapeHtml(t('reporte.quickHistory.empty'))}</option>
            ...
            <div class="visitor-quick-history-actions" aria-label="${escapeHtml(t('reporte.quickHistory.actions'))}">
              <button
              ...
              >
                ${escapeHtml(t('reporte.quickHistory.hide'))}
              </button>
            </div>
          </label>
          <label>
            <span>${escapeHtml(t('reporte.visitors.name'))}</span>
            <input id="visitor-quick-name" data-visitor-field="name" type="text" placeholder="${escapeHtml(t('reporte.visitors.fullName'))}" value="${escapeHtml(visitorQuickForm.name)}">
          </label>
          <label>
            <span>${escapeHtml(t('reporte.visitors.type'))}</span>
            <select id="visitor-quick-kind" class="fn-select" data-visitor-field="kind">
              <option value="amigo"${visitorQuickForm.kind === 'amigo' ? ' selected' : ''}>${escapeHtml(t('reporte.visitors.type.friend'))}</option>
              <option value="visita"${visitorQuickForm.kind === 'visita' ? ' selected' : ''}>${escapeHtml(t('reporte.visitors.type.restoration'))}</option>
            </select>
          </label>
          <label>
            <span>${escapeHtml(t('reporte.visitors.invitedBy'))}</span>
            <select id="visitor-quick-invited-by" class="fn-select" data-visitor-field="invitedBy">
              <option value="">${escapeHtml(t('reporte.visitors.invitedByPlaceholder'))}</option>
          ...
          <label id="visitor-quick-process-field"${visitorQuickForm.kind === 'visita' ? ' hidden' : ''}>
            <span>${escapeHtml(t('reporte.visitors.process'))}</span>
            ...
            <small id="visitor-quick-process-summary" class="visitor-quick-process-summary">${visitorQuickForm.kind === 'visita'
              ? escapeHtml(t('reporte.visitors.process.summaryRestoration'))
              : escapeHtml(t('reporte.visitors.process.summary', { reach: visitorQuickForm.reachAttended ? t('reporte.visitors.yes') : t('reporte.visitors.no'), process: visitorQuickForm.processEntry === 'late' ? t('reporte.visitors.process.late') : visitorQuickForm.processEntry === 'noted' ? t('reporte.visitors.yes') : t('reporte.visitors.no') }))}</small>
          </label>
          <div class="visitor-quick-toggles">
            ...
            <label class="quick-toggle-field">
              ...
              <span>${escapeHtml(t('reporte.visitors.firstTime'))}</span>
            </label>
            <label id="visitor-quick-converted-field" class="quick-toggle-field"${visitorQuickForm.kind === 'visita' || !showVisitorConversion ? ' hidden' : ''}>
              ...
              <span>${escapeHtml(t('reporte.visitors.conversion'))}</span>
            </label>
          ...
          <div class="visitor-quick-actions">
            <button type="button" class="btn-with-icon" data-action="add-visitor">
              ...
              <span>${escapeHtml(t('reporte.visitors.add'))}</span>
            </button>
            <button type="button" class="secondary btn-with-icon" data-action="reset-visitor-quick" title="${escapeHtml(t('reporte.visitors.resetTitle'))}">
              ...
              <span>${escapeHtml(t('reporte.visitors.reset'))}</span>
            </button>
          </div>
          <div class="helper-actions" aria-label="${escapeHtml(t('reporte.visitors.shortcutsAria'))}">
            <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="fill-sunday-visitors" data-stage-action="culto" id="mark-all-visitors-to-sunday" data-tooltip="${escapeHtml(t('reporte.visitors.fillSundayTooltip'))}">
              <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
              <span>${escapeHtml(t('reporte.visitors.fillSunday'))}</span>
            </button>
            <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-action="copy-visitor-reach-to-sunday" data-stage-action="culto" id="copy-visitor-reach-to-sunday" data-tooltip="${escapeHtml(t('reporte.visitors.copyReachToSundayTooltip'))}">
              <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
              <span>${escapeHtml(t('reporte.visitors.copyReachToSunday'))}</span>
            </button>
          </div>
        </div>
        <div class="table-wrap weekly-table-wrap">
          <table>
            <thead>
              <tr>
                <th>${escapeHtml(t('reporte.visitors.name'))}</th>
                <th>${escapeHtml(t('reporte.visitors.invitedBy'))}</th>
                ...
                <th>${escapeHtml(t('reporte.visitors.firstTime'))}</th>
                <th>${escapeHtml(t('reporte.visitors.process'))}</th>
                ${showVisitorConversion ? `<th class="col-conversion">${escapeHtml(t('reporte.visitors.conversion'))}</th>` : ''}
                ${showSeparateEventCapture
                  ...
                  : ''}
                ${showVisitorContacted ? `<th class="col-contactado">${escapeHtml(t('reporte.visitors.contacted'))}</th>` : ''}
                <th>${escapeHtml(t('reporte.visitors.phone'))}</th>
                <th>${escapeHtml(t('reporte.visitors.note'))}</th>
                <th>${escapeHtml(t('reporte.visitors.actions'))}</th>
              </tr>
            </thead>
        ...
        ${form.visitors.length ? form.visitors.map((visitor, index) => {
          ...
          const convertedCell = visitorKind === 'visita'
            ? `<td data-label="${escapeHtml(t('reporte.visitors.conversion'))}" class="checkbox-cell col-conversion"><span class="member-admin-caption" title="${escapeHtml(t('reporte.visitors.baptizedTooltip'))}">${escapeHtml(t('reporte.visitors.na'))}</span></td>`
            : `<td data-label="${escapeHtml(t('reporte.visitors.conversion'))}" class="checkbox-cell col-conversion"><input type="checkbox" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="converted"${visitor.converted ? ' checked' : ''}></td>`;
          const promoteAction = visitorKind === 'visita'
            ? `<label class="visitor-promote-toggle"><input type="checkbox" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="promoteToMember"${visitor.promoteToMember ? ' checked' : ''}> <span>${escapeHtml(t('reporte.visitors.promote'))}</span></label>`
            : '';
          const kindChip = `<span class="visitor-kind-chip is-${visitorKind}" title="${escapeHtml(visitorKind === 'visita' ? t('reporte.visitors.type.restoration') : t('reporte.visitors.type.friend'))}">${escapeHtml(visitorKind === 'visita' ? t('reporte.visitors.kind.visit') : t('reporte.visitors.kind.friend'))}</span>`;
          const visitorFlags = [];
          if (visitor.reachAttended) visitorFlags.push({ key: 'reach', label: t('reporte.visitors.reachShort') });
          if (visitor.sundayAttended) visitorFlags.push({ key: 'sunday', label: t('reporte.visitors.serviceShort') });
          if (visitor.firstVisit) visitorFlags.push({ key: 'first', label: t('reporte.visitors.firstShort') });
          if (effectiveProcessEntry === 'noted') visitorFlags.push({ key: 'proc', label: t('reporte.visitors.processShort') });
          if (effectiveProcessEntry === 'late') visitorFlags.push({ key: 'late', label: t('reporte.visitors.lateShort') });
          if (visitor.converted) visitorFlags.push({ key: 'conv', label: t('reporte.visitors.conversionShort') });
          if (visitor.contacted) visitorFlags.push({ key: 'cont', label: t('reporte.visitors.contactedShort') });
          const flagsHtml = visitorFlags.length
            ? visitorFlags.map((flag) => `<span class="vsum-flag" data-flag="${flag.key}">${flag.label}</span>`).join('')
            : `<span class="vsum-flag is-empty">${escapeHtml(t('reporte.visitors.noFlags'))}</span>`;
          const displayName = String(visitor.name || '').trim() || `${t('reporte.visitors.kind.visit')} ${index + 1}`;
                  ...
                  <td class="visitor-summary-cell" data-label="">
                    <button type="button" class="visitor-summary-toggle" data-action="toggle-visitor" data-visitor-index="${escapeHtml(index)}" aria-expanded="false">
                      <div class="vsum-main">
                        ...
                        <span class="vsum-meta">${escapeHtml(visitorKind === 'visita' ? t('reporte.visitors.kind.visit') : t('reporte.visitors.kind.friend'))}${invitedLabel ? ` · ${escapeHtml(t('reporte.visitors.invitedByMeta', { name: invitedLabel }))}` : ''}</span>
                      </div>
          ...
          return `
                <tr class="is-collapsed">
                  ${summaryCell}
                  <td data-label="${escapeHtml(t('reporte.visitors.name'))}">
                    <div class="visitor-name-cell">
                      <select data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="kind" class="visitor-table-select" title="${escapeHtml(t('reporte.visitors.typeTitle'))}">
                        <option value="amigo"${visitorKind === 'amigo' ? ' selected' : ''}>${escapeHtml(t('reporte.visitors.type.friend'))}</option>
                        <option value="visita"${visitorKind === 'visita' ? ' selected' : ''}>${escapeHtml(t('reporte.visitors.type.restoration'))}</option>
                      </select>
                      <input type="text" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="name" value="${escapeHtml(visitor.name)}" placeholder="${escapeHtml(t('reporte.visitors.name'))}">
                      ${kindChip}
                    </div>
                  </td>
                  <td data-label="${escapeHtml(t('reporte.visitors.invitedBy'))}">
                  ...
                  <td data-label="${escapeHtml(t('reporte.visitors.firstTime'))}" class="checkbox-cell">
                    <input type="checkbox" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="firstVisit"${visitor.firstVisit ? ' checked' : ''}>
                  </td>
                  <td data-label="${escapeHtml(t('reporte.visitors.process'))}">
                    ${visitorKind === 'visita'
                      ? `<span class="member-admin-caption">${escapeHtml(t('reporte.visitors.restoration'))}</span>`
                      : processLocked
                  ...
                  ${showVisitorContacted ? `<td data-label="${escapeHtml(t('reporte.visitors.contacted'))}" class="checkbox-cell col-contactado">
                    <input type="checkbox" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="contacted"${visitor.contacted ? ' checked' : ''}>
                  </td>` : ''}
                  <td data-label="${escapeHtml(t('reporte.visitors.phone'))}">
                    <input type="text" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="phone" value="${escapeHtml(visitor.phone || '')}" placeholder="${escapeHtml(t('reporte.visitors.phone'))}">
                  </td>
                  <td data-label="${escapeHtml(t('reporte.visitors.note'))}">
                    <input type="text" data-visitor-index="${escapeHtml(index)}" data-visitor-update-field="note" value="${escapeHtml(visitor.note || '')}" placeholder="${escapeHtml(t('reporte.visitors.note'))}">
                  </td>
                  <td data-label="${escapeHtml(t('reporte.visitors.actions'))}">
                    <div class="visitor-actions-cell">
                      ${promoteAction}
                      <button type="button" class="danger" data-action="remove-visitor" data-visitor-index="${escapeHtml(index)}">${escapeHtml(t('reporte.visitors.remove'))}</button>
                    </div>
                  </td>
                </tr>
          `;}).join('') : `
                <tr>
                  <td colspan="${visitorTableColspan}" class="empty-state">${escapeHtml(t('reporte.visitors.empty'))}</td>
                </tr>
          `}
            </tbody>
          </table>
      ...
      <section class="panel panel-soft full-width${stageClass('alcance')}" data-stage="alcance">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.kids.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.kids.title'))}</h2>
          </div>
        </div>
        <div id="kid-quick-form" class="visitor-quick-form">
          <label>
            <span>${escapeHtml(t('reporte.kids.name'))}</span>
            <input id="kid-quick-name" data-kid-quick-field="name" type="text" placeholder="${escapeHtml(t('reporte.kids.fullName'))}" value="${escapeHtml(kidQuickForm.name || '')}">
          </label>
          <label>
            <span>${escapeHtml(t('reporte.kids.guardian'))}</span>
            <input data-kid-quick-field="guardianName" type="text" placeholder="${escapeHtml(t('reporte.kids.guardianPlaceholder'))}" value="${escapeHtml(kidQuickForm.guardianName || '')}">
          </label>
          <div class="visitor-quick-toggles">
            ${showKidReach
              ? `<label id="kid-quick-reach-field" class="quick-toggle-field">
                ...
                <span>${escapeHtml(t('reporte.stage.reach'))}</span>
              </label>`
              : ''}
          </div>
          <div class="visitor-quick-actions">
            <button type="button" class="btn-with-icon" data-action="add-kid">
              <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
              <span>${escapeHtml(t('reporte.kids.add'))}</span>
            </button>
            <button type="button" class="secondary btn-with-icon" data-action="reset-kid-quick" title="${escapeHtml(t('reporte.kids.resetTitle'))}">
              <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 3-6.7"/><polyline points="3 4 3 10 9 10"/></svg>
              <span>${escapeHtml(t('reporte.kids.reset'))}</span>
            </button>
          </div>
        </div>
        <div class="helper-actions" aria-label="${escapeHtml(t('reporte.kids.shortcutsAria'))}">
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-stage-action="culto" data-action="fill-sunday-kids">
            <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
            <span>${escapeHtml(t('reporte.kids.fillSunday'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button stage-action btn-with-icon" data-stage-action="culto" data-action="copy-kid-reach-to-sunday">
            <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            <span>${escapeHtml(t('reporte.kids.copyReachToSunday'))}</span>
          </button>
          <button type="button" class="secondary helper-action-button btn-with-icon" data-action="clear-kids">
            <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>
            <span>${escapeHtml(t('reporte.kids.clear'))}</span>
          </button>
        </div>
        <div class="member-summary">
          <span class="member-summary-label">${escapeHtml(t('reporte.kids.preloaded'))}</span>
        ...
        <div class="table-wrap weekly-table-wrap">
          <table>
            <thead>
              <tr>
                <th>${escapeHtml(t('reporte.kids.column.kid'))}</th>
                <th>${escapeHtml(t('reporte.kids.column.guardian'))}</th>
                <th>${escapeHtml(t('reporte.kids.column.source'))}</th>
                ${showKidReach ? `<th>${escapeHtml(t('reporte.stage.reach'))}</th>` : ''}
                ${showKidSunday ? `<th>${escapeHtml(t('reporte.stage.service'))}</th>` : ''}
                <th>${escapeHtml(t('reporte.kids.column.note'))}</th>
                <th>${escapeHtml(t('reporte.kids.column.actions'))}</th>
              </tr>
            </thead>
            <tbody id="kids-table-body">
              ${form.kids.length ? form.kids.map((kid, index) => `
                <tr>
                  <td data-label="${escapeHtml(t('reporte.kids.column.kid'))}"><input type="text" data-kid-index="${escapeHtml(index)}" data-kid-field="name" value="${escapeHtml(kid.name || '')}" placeholder="${escapeHtml(t('reporte.kids.name'))}"${kid.source === 'catalog' ? ' disabled' : ''}></td>
                  <td data-label="${escapeHtml(t('reporte.kids.column.guardian'))}">
                    <input type="text" data-kid-index="${escapeHtml(index)}" data-kid-field="guardianName" value="${escapeHtml(kid.guardianName || '')}" placeholder="${escapeHtml(t('reporte.kids.guardian'))}">
                  </td>
                  <td data-label="${escapeHtml(t('reporte.kids.column.source'))}">${escapeHtml(kid.source === 'catalog' ? t('reporte.kids.source.cell') : t('reporte.kids.source.visit'))}</td>
                  ${showKidReach ? `<td data-label="${escapeHtml(t('reporte.stage.reach'))}" class="checkbox-cell">
                    <input type="checkbox" data-kid-index="${escapeHtml(index)}" data-kid-field="reachAttended"${kid.reachAttended ? ' checked' : ''}>
                  </td>` : ''}
                  ${showKidSunday ? `<td data-label="${escapeHtml(t('reporte.stage.service'))}" class="checkbox-cell">
                    <input type="checkbox" data-kid-index="${escapeHtml(index)}" data-kid-field="sundayAttended"${kid.sundayAttended ? ' checked' : ''}>
                  </td>` : ''}
                  <td data-label="${escapeHtml(t('reporte.kids.column.note'))}">
                    <input type="text" data-kid-index="${escapeHtml(index)}" data-kid-field="note" value="${escapeHtml(kid.note || '')}" placeholder="${escapeHtml(t('reporte.kids.notePlaceholder'))}">
                  </td>
                  <td data-label="${escapeHtml(t('reporte.kids.column.actions'))}">
                    ${kid.source === 'catalog'
                      ? `<span class="member-admin-caption">${escapeHtml(t('reporte.kids.preloadedBadge'))}</span>`
                      : `<button type="button" class="secondary" data-action="remove-kid" data-kid-index="${escapeHtml(index)}">${escapeHtml(t('reporte.kids.remove'))}</button>`}
                  </td>
                </tr>
              `).join('') : `
                <tr>
                  <td colspan="${kidTableColspan}" class="empty-state">${escapeHtml(t('reporte.kids.empty'))}</td>
                </tr>
              `}
            </tbody>
          </table>
      ...
      <section class="panel panel-soft full-width${stageClass('alcance')}" data-stage="alcance">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.reachExtras.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.reachExtras.title'))}</h2>
          </div>
        </div>

        <div class="metric-subgroup">
          <p class="metric-subgroup-title">${escapeHtml(t('reporte.reachExtras.meetingTitle'))}</p>
          <div class="metric-fields">
            <label class="metric-field">
              <span>${escapeHtml(t('reporte.metrics.field.offering'))}</span>
        ...
        <div class="metric-subgroup">
          <p class="metric-subgroup-title">${escapeHtml(t('reporte.reachExtras.externalTitle'))}</p>
          <div class="metric-fields">
            <div class="reach-supervision-box">
              <p class="reach-supervision-help">${escapeHtml(t('reporte.reachExtras.externalHelp'))}</p>
              <div class="reach-supervision-summary">${reachExternalSelected.length ? escapeHtml(t('reporte.reachExtras.externalSummary', { count: String(reachExternalSelected.length), plural: reachExternalSelected.length === 1 ? '' : 's', items: reachExternalSelected.map((entry) => `${state.reachExternalKindLabel(entry.kind)} · ${entry.name}`).join(', ') })) : escapeHtml(t('reporte.reachExtras.externalSummaryEmpty'))}</div>
              <div class="reach-supervision-list">
                ${reachExternalRows.length ? reachExternalRows.map((entry) => {
                  ...
                  if (entry.relatedSector) meta.push(t('reporte.preview.sectorMeta', { sector: entry.relatedSector }));
                  if (entry.homeCellNumber) meta.push(t('reporte.preview.cellMeta', { cell: entry.homeCellNumber }));
                  return `
                  ...
                  `;
                }).join('') : `<p class="member-admin-caption">${escapeHtml(t('reporte.reachExtras.noCandidates'))}</p>`}
              </div>
              <div class="reach-external-add-row">
                <label>
                  <span>${escapeHtml(t('reporte.reachExtras.visitingBrother'))}</span>
                  <select data-external-member-visit-select>
                    <option value="">${escapeHtml(reachExternalMemberCandidates.length ? t('reporte.reachExtras.selectBrother') : t('reporte.reachExtras.noExternalBrothers'))}</option>
                    ${reachExternalMemberCandidates.map((entry) => `
                      <option value="${escapeHtml(entry.personId || '')}">${escapeHtml(`${entry.name} · ${t('reporte.preview.cellMeta', { cell: entry.homeCellNumber || '—' })}`)}</option>
                    `).join('')}
                  </select>
                </label>
                <button type="button" class="secondary" data-action="add-external-member-visit">${escapeHtml(t('reporte.reachExtras.add'))}</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="fn-shell__card panel panel-soft full-width${stageClass('culto')}" data-stage="culto">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.baptisms.eyebrow'))}</p>
            <div class="baptism-title-row">
              <h2>${escapeHtml(t('reporte.baptisms.title'))}</h2>
              <div class="baptism-summary-pills">
                ${[1, 2, 3].map((quarter) => `
                  <span class="pill baptism-summary-pill${activeQuarter === quarter ? ' is-current' : ''}" title="${escapeHtml(activeQuarter === quarter ? t('reporte.baptisms.currentQuarter', { quarter }) : t('reporte.baptisms.quarterSummary', { quarter }))}">
                ...
                `).join('')}
                <span class="pill baptism-summary-pill baptism-summary-pill--annual" title="${escapeHtml(t('reporte.baptisms.annualSummary'))}">
                  <span class="baptism-summary-pill__label">${escapeHtml(t('reporte.baptisms.annual'))}</span>
          ...
          <button type="button" id="add-baptism-button" class="secondary btn-with-icon" data-action="add-baptism" title="${escapeHtml(baptismCaptureStatus.isAllowed ? '' : baptismRegistrationMessage)}">
            ...
            <span>${escapeHtml(t('reporte.baptisms.register'))}</span>
          </button>
        </div>
        <div class="member-summary">
          <span class="member-summary-label baptism-summary-caption">${escapeHtml(t('reporte.baptisms.summaryCaption'))}</span>
        </div>
        <br>
        <div class="baptism-copy-block">
          ${baptismCaptureStatus.isAllowed
            ...
            : `<p class="member-admin-caption baptism-copy-note">${escapeHtml(baptismRegistrationMessage)}</p>
               <p class="member-admin-caption baptism-copy-note">${escapeHtml(t('reporte.baptisms.promoteNote'))}</p>`}
        </div>
        <div class="table-wrap weekly-table-wrap">
          <table>
            <thead>
              <tr>
                <th>${escapeHtml(t('reporte.baptisms.column.person'))}</th>
                <th>${escapeHtml(t('reporte.baptisms.column.date'))}</th>
                <th>${escapeHtml(t('reporte.baptisms.column.source'))}</th>
                <th>${escapeHtml(t('reporte.baptisms.column.promote'))}</th>
                <th>${escapeHtml(t('reporte.baptisms.column.note'))}</th>
                <th>${escapeHtml(t('reporte.baptisms.column.actions'))}</th>
              </tr>
            </thead>
            <tbody id="baptism-table-body">
              ${form.baptisms.length ? form.baptisms.map((entry, index) => `
                <tr>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.person'))}"><input type="text" class="fn-input" data-baptism-index="${escapeHtml(index)}" data-baptism-update-field="name" value="${escapeHtml(entry.name || '')}"></td>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.date'))}"><input type="date" class="fn-input" data-baptism-index="${escapeHtml(index)}" data-baptism-update-field="baptismDate" value="${escapeHtml(entry.baptismDate || '')}"></td>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.source'))}">
                    <select class="fn-select" data-baptism-index="${escapeHtml(index)}" data-baptism-update-field="source">
                      <option value="report"${entry.source === 'report' ? ' selected' : ''}>${escapeHtml(t('reporte.baptisms.source.report'))}</option>
                      <option value="fuera-cierre"${entry.source === 'fuera-cierre' ? ' selected' : ''}>${escapeHtml(t('reporte.baptisms.source.outside'))}</option>
                    </select>
                  </td>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.promote'))}" class="checkbox-cell"><input type="checkbox" data-baptism-index="${escapeHtml(index)}" data-baptism-update-field="promoteToMember"${entry.promoteToMember ? ' checked' : ''}></td>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.note'))}"><input type="text" class="fn-input" data-baptism-index="${escapeHtml(index)}" data-baptism-update-field="note" value="${escapeHtml(entry.note || '')}" placeholder="${escapeHtml(t('reporte.baptisms.notePlaceholder'))}"></td>
                  <td data-label="${escapeHtml(t('reporte.baptisms.column.actions'))}"><button type="button" class="baptism-action-button baptism-action-button--row" data-action="remove-baptism" data-baptism-index="${escapeHtml(index)}">${escapeHtml(t('reporte.baptisms.remove'))}</button></td>
                </tr>
              `).join('') : `
                <tr>
                  <td colspan="6" class="empty-state">${escapeHtml(baptismCaptureStatus.isAllowed ? t('reporte.baptisms.empty') : baptismRegistrationMessage)}</td>
                </tr>
              `}
            </tbody>
          </table>
      ...
      <details class="metrics-section-collapse full-width${stageClass('cierre')}" data-stage="cierre">
        <summary class="metrics-section-summary">
          <span>${escapeHtml(t('reporte.close.metrics'))}</span>
      ...
      <section class="panel panel-soft full-width${stageClass('cierre')}" data-stage="cierre">
        <div class="panel-head">
          <div>
            <p class="eyebrow">${escapeHtml(t('reporte.close.eyebrow'))}</p>
            <h2>${escapeHtml(t('reporte.close.notesTitle'))}</h2>
          </div>
        </div>
        <label class="fn-field">
          <span>${escapeHtml(t('reporte.close.notesLabel'))}</span>
          <textarea name="notes" data-report-field="notes" rows="5" class="fn-input" placeholder="${escapeHtml(t('reporte.close.notesPlaceholder'))}">${escapeHtml(form.notes || '')}</textarea>
        </label>
        <div class="fn-form-actions cierre-actions">
          <button type="button" class="btn-with-icon" data-action="open-preview-current-report">
            ...
            <span>${escapeHtml(t('common.preview'))}</span>
          </button>
        </div>
      </section>
      <div class="stage-save-bar full-width${stageClass('cierre')}" data-stage="cierre">
        <button type="button" class="btn-save-next btn-with-icon" data-action="save-report-stage" data-next-stage="cierre"${saveDisabledAttr}>
          ...
          <span>${escapeHtml(t('reporte.finalize'))}</span>
        </button>
      </div>
